...
data class Meal(val id: String, val modifiedAt: String, val title : String, val time: String, val menu : String, val kcal: Int, val course: String, val photoURL: String?) {
